# Project made in local computer

# .env used

DATABASE_URL=postgres://postgres:admin@localhost:5432/example
...
3.1 if using docker (recommended) use `$ docker run --name postgres-db -e POSTGRES_PASSWORD=docker -p 5432:5432 -d postgres`
